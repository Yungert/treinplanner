                            ...
                            if (!rit.alternativeTransport) {
                                ritDetail = RitDetail(
                                    ...
                                    geplandeVertrektijd = rit?.stops?.getOrNull(0)?.plannedDepartureDateTime
                                        ?: "",
                                    vertrekSpoor = rit?.stops?.getOrNull(0)?.actualDepartureTrack
                                        ?: rit?.stops?.getOrNull(0)?.plannedDepartureTrack ?: "",
                                    vertragingInSecondeVertrekStation = rit?.stops?.getOrNull(0)?.departureDelayInSeconds
                                        ?: 0,
                                    ...
                                    aankomstSpoor = rit.stops.getOrNull(
                                        rit?.stops?.size?.minus(1) ?: 0
                                    )?.actualArrivalTrack ?: rit.stops.getOrNull(
                                        rit?.stops?.size?.minus(1) ?: 0
                                    )?.plannedArrivalTrack ?: "",
                                    vertragingInSecondeAankomstStation = rit.stops.getOrNull(
                                        rit?.stops?.size?.minus(
                                            1
                                        ) ?: 0
